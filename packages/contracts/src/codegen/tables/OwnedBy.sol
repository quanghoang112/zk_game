...
library OwnedBy {
   ...
   * @notice Get PlayerId.
   */
  function get(bytes32 PlanetId) internal view returns (bytes32 PlayerId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = PlanetId;
   ...
   * @notice Get PlayerId.
   */
  function _get(bytes32 PlanetId) internal view returns (bytes32 PlayerId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = PlanetId;
   ...
   * @notice Set PlayerId.
   */
  function set(bytes32 PlanetId, bytes32 PlayerId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = PlanetId;
   ...
   * @notice Set PlayerId.
   */
  function _set(bytes32 PlanetId, bytes32 PlayerId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = PlanetId;
   ...
   */
  function encodeStatic(bytes32 PlayerId) internal pure returns (bytes memory) {
   ...
   */
  function encode(bytes32 PlayerId) internal pure returns (bytes memory, EncodedLengths, bytes memory) {
    bytes memory _staticData = encodeStatic(PlayerId);
