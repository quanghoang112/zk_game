...
library Stats {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "Stats", typeId: RESOURCE_TABLE });`
   ...
   * @notice Get energy.
   */
  function getEnergy(bytes32 id) internal view returns (uint32 energy) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Get energy.
   */
  function _getEnergy(bytes32 id) internal view returns (uint32 energy) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Set energy.
   */
  function setEnergy(bytes32 id, uint32 energy) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Set energy.
   */
  function _setEnergy(bytes32 id, uint32 energy) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   */
  function get(bytes32 id) internal view returns (StatsData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Get the full data.
   */
  function _get(bytes32 id) internal view returns (StatsData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   */
  function set(bytes32 id, StatsData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.health, _table.energy);
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(bytes32 id, StatsData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.health, _table.energy);
  ...
  function decode(
    ...
    (_table.health, _table.energy) = decodeStatic(_staticData);
  }
